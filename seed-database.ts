...
// Creating new client and specifying model
...
// Employee Schema with Mongo DB relational database
const EmployeeSchema = z.object({
  ...
  // Creating an employee with inference to the schema above
...
// Summary of each employee then make vector embeddings of each summary
async function createEmployeeSummary(employee: Employee): Promise<string> {
  ...
  async function seedDatabase(): Promise<void> {
    try {
      ...
      await collection.deleteMany({}); // Do not collect multiple employees
